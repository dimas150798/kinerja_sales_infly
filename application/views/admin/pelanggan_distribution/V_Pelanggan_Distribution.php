                    ...
                    <div class="row">
                        <div class="col-sm-3 col-lg-4 mt-3">
                            <div class="card mb-4" style="--cui-card-cap-bg: #3b5998">
                                ...
                                <div class="card-body row text-center">
                                    <div class="col">
                                        <div class="fs-5 fw-semibold"><?php echo $JumlahDistribution_All ?></div>
                        ...
                        <div class="col-sm-3 col-lg-4 mt-3">
                            <div class="card mb-4" style="--cui-card-cap-bg: #3b5998">
                                ...
                                <div class="card-body row text-center">
                                    <div class="col">
                                        <div class="fs-5 fw-semibold"><?php echo $JumlahDistribution_KBS ?></div>
                                        <div class="text-uppercase text-medium-emphasis small">Kebonsari</div>
                                    </div>
                                    <div class="vr"></div>
                                    <div class="col">
                                        <div class="fs-5 fw-semibold"><?php echo $JumlahDistribution_TRW ?></div>
                        ...
                        <div class="col-sm-3 col-lg-4 mt-3">
                            <div class="card mb-4" style="--cui-card-cap-bg: #3b5998">
                                ...
                                <div class="card-body row text-center">
                                    <div class="col">
                                        <div class="fs-5 fw-semibold"><?php echo $JumlahDistribution_Kanigaran ?></div>
                                        <div class="text-uppercase text-medium-emphasis small">Kanigaran</div>
                                    </div>
                                    <div class="vr"></div>
                                    <div class="col">
                                        <div class="fs-5 fw-semibold"><?php echo $JumlahDistribution_Dringu ?></div>
