    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card">
                ...
                <div class="card-body">
                    <h4 class="fs-3 fw-bold">Edit Customer Survey</h4>

                    <?php foreach ($DataPelanggan as $data) : ?>

                        <form method="POST" action="<?php echo base_url('admin/pelanggan_survey/C_Edit_Pelanggan_Survey/EditPelangganSave') ?>">
                            ...
                            <div class="row mt-4">
                                <div class="col-sm-12 col-lg-6 mt-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control bg-secondary fw-bold" id="kode_sheets" name="kode_sheets" value="<?php echo $data['kode_sheet'] ?>" placeholder="Kode Sheet" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-lg-6 mt-2">
