...
class C_Edit_Pelanggan_Distribution extends CI_Controller
{
    ...
    public function EditPelanggan($id_sheet)
    {
        ...
        $this->load->view('admin/pelanggan_distribution/V_Edit_Pelanggan_Distribution', $data);
    ...
    public function EditPelangganSave()
    {
        ...
        redirect('admin/pelanggan_distribution/C_Pelanggan_Distribution');
    }
}
