...
class C_Edit_Pelanggan_Aktif extends CI_Controller
{
    ...
    public function EditPelanggan($id_sheet)
    {
        ...
        $data['DataStatus'] = $this->M_DataStatus->DataStatus_Active();
        $data['KodeSheets'] = $this->M_DataSheets->generateCode();

        $this->load->view('template/V_Header', $data);
        $this->load->view('template/V_Sidebar', $data);
        $this->load->view('admin/pelanggan_aktif/V_Edit_Pelanggan_Aktif', $data);
    ...
    public function EditPelangganSave()
    {
        ...
        // Check Tanggal Terminasi
        $TanggalTerminasi               = empty($tanggal_terminasi) ? null : $tanggal_terminasi;
        ...
        redirect('admin/pelanggan_aktif/C_Pelanggan_Aktif');
    }
}
